...
const TimeForm: FC<TimeFormProps> = ({ mainform, setpage }) => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-3">
      <p className="font-oswald text-3xl font-semibold text-[#9bd49f]">
        Request a reservation
      </p>
      <p className="font-poppins text-[#323232]">
                  ...
                  <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
                    <PopoverTrigger asChild>
                      <FormControl>
                        <Button
                          variant={"outline"}
                          className={`h-12 w-full justify-start border-muted bg-transparent text-left font-normal text-[#323232] hover:bg-[#9bd49f] hover:text-[#323232]`}
                        >
                ...
                {generateTimeSlots().map((time) => (
                  <div
                    ...
                    className={cn(
                      ...
                      form.watch("time") === time && "border-[#9bd49f]",
                    )}
                  >
                    {time}
                  </div>
