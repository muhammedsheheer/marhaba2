        ...
        <div className="flex h-full w-full flex-col items-center justify-center gap-2 lg:gap-4">
          <div className="flex flex-col items-center justify-center gap-2 pb-10 md:pb-24">
            <motion.h6
              ...
              whileInView="visible"
              viewport={{ amount: 0.5 }}
              className="text-center font-oswald text-4xl font-[400] uppercase tracking-[3px] text-[#9bd49f] md:text-7xl md:tracking-[4px]"
            >
          ...
          {reviews && (
            <Carousel className="w-full px-4 md:px-60 2xl:px-[450px]">
              ...
              <div className="group absolute -bottom-12 left-1/2 flex w-fit -translate-x-1/2 transform items-center gap-2 pb-8 transition-transform duration-300 ease-in-out">
                <CarouselPrevious className="border-[#9bd49f] text-[#9bd49f] transition-transform duration-300 ease-in-out group-hover:-translate-x-2" />
                <CarouselNext className="border-[#9bd49f] text-[#9bd49f] transition-transform duration-300 ease-in-out group-hover:translate-x-2" />
              </div>
            </Carousel>
          )}
        </div>
